...
NSString *const MJRefreshFooterPullToRefresh = @"上拉可以加载更多资讯";
NSString *const MJRefreshFooterReleaseToRefresh = @"松开立即加载更多资讯";
NSString *const MJRefreshFooterRefreshing = @"正在加载更多咨询...";
