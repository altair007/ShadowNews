...
- (instancetype) init
{
    if (self = [super init]) {
        ...
        NSArray * itemsAdded = @[@"本地", @"财经", @"体育", @"军事", @"推荐", @"娱乐", @"聚合阅读", @"头条"];
        NSArray * itemsNotAdded = @[@"社会", @"论坛", @"NBA", @"中超", @"CBA", @"电影", @"国际足球", @"数码", @"彩票", @"世界杯", @"博客", @"科技", @"轻松一刻", @"原创", @"汽车", @"手机", @"移动互联", @"精选", @"房产", @"家居", @"游戏", @"读书", @"教育", @"旅游", @"酒香", @"暴雪游戏",@"亲子", @"葡萄酒", @"时尚", @"情感"];
        NSString * itemLastScan = @"头条";
